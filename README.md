...
2. Digitize DSC curves and stress–strain curves where tables are not available.
3. Expand the ML dataset with real values for density, Af, hysteresis, UTS, elongation, recovery strain, and residual strain.
